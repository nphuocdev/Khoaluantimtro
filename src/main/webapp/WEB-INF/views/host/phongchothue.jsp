    ...
    <body>
        ...
        <div class="about wow fadeInUp" data-wow-delay="0.1s">
           <div style="margin: 50px">
			   <div class="row">
				   <div class="col-10">
					   <h4><b>${PlaceByAccId.size()} phòng cho thuê</b></h4>
				   </div>
				   <div class="col-2 float-lg-right">
					   <a href="/become-a-host" class="btn" style="color:#fff3cd;background: #356e6e"><i class="fas fa-plus"></i> Tạo phòng trọ mới</a>
				   </div>
			   </div>
											...
											<c:forEach var="rate" items="${ratings }" varStatus="i">
												...
												<tr>
													...
													<td class="">
														...
														<p><i style="color: #ee731f" class="fas fa-star"></i>${rate}</p>
													</td>
													...
													<td class="">
														<p class=""><b>${item.price }</b> đồng/ đêm</p>
													</td>
													<td class="">
														<p class="">
													...
													<td class="cart_total chucnang" style="text-align: center">
														...
														<c:if test="${item.isAccept == false}">
															<a href="<c:url value="/become-a-host/listings/delete/${item.placeId }" />" class="remove-place">
																<i class="fas fa-trash" style="color: #f51414"></i>
															</a>
														</c:if>
													</td>
												</tr>
