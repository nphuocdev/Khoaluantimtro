...
<div class="about wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        <h4><b style="font-size: 24px"> Quản lý Blog</b></h4>
        <br>

        <div class="row">
            <div class="col-2 float-lg-right">
                <a href="/become-a-host/blog/add" class="btn" style="background: #356e6e;color: #fff3cd"><i class="fas fa-plus"></i> Tạo blog</a>
            </div>
        </div>
                        ...
                        <div class="row" style="margin: 30px 0; border-bottom: 1px solid #f0f0f0; padding-bottom: 30px">
                            ...
                            <div class="col-7">
                                ...
                                <div style="position: absolute; bottom: 0">
                                    <a href="/become-a-host/blog/edit/${i.blogId}" style="color: #0d6efd;border-color: #0d6efd;background-color: #90C9DC" class="btn blog-edit">Chỉnh sửa</a>
                                    <a href="/become-a-host/blog/delete/${i.blogId}" style="color: #fff3cd;border-color: #0d6efd;background-color: red"class="btn btn-light border delete-blog">Xoá</a>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
