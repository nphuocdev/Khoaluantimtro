...
<%--    <div class="ileft">--%>
<%--        <div class="tomtat">--%>
<%--            <h5>Chi tiết phòng trọ</h5>--%>
<%--            <p>Ảnh</p>--%>
<%--            <p>Thông tin cơ bản phòng trọ</p>--%>
<%--            <p>Mô tả</p>--%>
<%--            <p>Địa chỉ</p>--%>
<%--            <p>Trạng thái</p>--%>
<%--            <p>Chỗ ở và phòng</p>--%>
...
<%--    </div>--%>
    <div  class="container">
        ...
        <h5>Thông tin cơ bản về phòng trọ</h5>
        ...
        <input value="${detailPlace.price }" name="price" id="price" type="number" class="price">đồng<br>
        <div id="ajax-response4"></div>

        <button class="edit" onclick="editPrice()">Chỉnh sửa</button>
        <br>

        <p class="asa">Ngày cho thuê:</p><br>
        <label>Ngày bắt đầu </label>
        <input value="${detailPlace.startDay }" name="startDay" id="startDay" type="date" class="date"><br>
        ...
        <c:choose>
            <c:when test="${detailPlace.isEmpty == 'true' }">
                <input value="true" name="radio" type="radio" class="date isEmpty" value="1" checked> Đã đăng
<br>
                <input value="false" name="radio" type="radio" class="date isEmpty" value="0"> Đã hủy đăng

            </c:when>
            <c:otherwise>
                <input value="true" name="radio" type="radio" class="date isEmpty" value="1"> Đã đăng

                <input value="false" name="radio" type="radio" class="date isEmpty" value="0" checked> Đã hủy đăng
...
<%--        </div>--%>
        <!-- </form> -->
        <button  style="margin-left: 40%;background-color: #0c5460;border-radius:20px;padding: 10px 30px"> <a style="color: #FFFFFF!important;" href="/become-a-host/listings">Hoàn thành</a></button>
