...
<header id="header" style="background-color:#0c5460"><!--header-->
    <div class="i-head">
        <div class="row  ">
            <div class="col-sm-3">
            ...
            <div  class=" col-sm-5 ">
                ...
                <div class="menu_block">
                    <nav class="horizontal-nav full-width horizontalNav-notprocessed">
                        <ul style="display: flex;gap:20px;padding-top: 20px" class="sf-menu">
                            <li ><a style="font-weight: bold;font-size: 20px;color: #FFFFFF" href="<c:url value="/places" />">PHÒNG TRỌ</a></li>
                            <li> <a style="font-weight: bold;font-size: 20px;color: #FFFFFF" href="/show-map">BẢN ĐỒ</a></li>
                            <li><a style="font-weight: bold;font-size: 20px;color: #FFFFFF" href="<c:url value="become-a-host/listings" />">TẠO PHÒNG </a></li>
                            <li><a style="font-weight: bold;font-size: 20px;color: #FFFFFF" href="<c:url value="/blog" />">BLOG</a></li>
                            <li><a  style="font-weight: bold;font-size: 20px;color: #FFFFFF" href="<c:url value="/index" />">HỖ TRỢ</a></li>
                        </ul>
                    </nav>
                    <div class="clear"></div>
                </div>
        ...
        <div class="iright">
            ...
            <form action="<c:url value="/manager-account" />" method="post">
                ...
                <div class="form-group"><br>
                    <button style="background-color: #0d6efd" class="save">Lưu</button>
                </div>
            </form>
        </div>
                    ...
                    <span class="wrap hotness">
						 <form id="newHotnessForm" action="<c:url value="/manager-account/edit-image" />" method="post"
							...
							<div class="modal-footer">
								...
								<button type="submit" style="background-color: #0d6efd"class="btn ">Lưu</button>
							</div>        
						</form>
					</span>
                </div>
