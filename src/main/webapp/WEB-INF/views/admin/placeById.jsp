				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							...
							<br>
							<h3>Thông tin cơ bản về phòng cho thuê</h3>
							<br> <label>Tiêu đề phòng cho thuê</label><br> <input
								value="${detailPlace.name }" name="tieude" class="tieude"><br>
							<br>
							<br>
							
							<br> <label>Mô tả phòng cho thuê</label><br>
							...
							<br> <label>Giá cho thuê phòng</label> <input
...
<%--							--%>
							...
							<!--  -->
							<label class="asa">Trạng thái phòng cho thuê </label><br>
							<br>
							<c:choose>
							...
							<hr>
							<h3>Thông tin về chủ phòng</h3><br>
