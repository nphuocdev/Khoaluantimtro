        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalThem">
            	<i class="material-icons large">add_box</i> Thêm mới
            </button>
			
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Category Place</h4>
                  <p class="card-category"> Danh sách Danh mục</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                  	<c:choose>
                  		<c:when test="${categoryList.size() > 0 }">
                  			<table class="table">
		                      <thead style="background-color: #0c5460; color: white" class=" text-primary">
		                        <th>
		                          STT
		                        </th>
		                        <th>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action ="<c:url value="/manager-category/add" />" method="post">
				<label for="exampleFormControlFile1" class="">Mã Danh mục</label><br>
				<input type="text" class="form-control-file " id="exampleFormControlFile1" name="categoryId"><br>
				  
				<label for="exampleFormControlFile1" class="">Tên Danh mục</label>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action ="<c:url value="/manager-category/edit" />" method="post">
	        	...
	        	<div class="">
				    <label for="exampleFormControlFile1" class="">Mã Danh mục</label>
