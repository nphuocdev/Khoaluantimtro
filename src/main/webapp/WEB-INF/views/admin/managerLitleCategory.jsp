  ...
  <div class="main-panel">
    ...
    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example" style="background-color: darkslategrey !important;color:#fff">
      <div class="container-fluid">
        <div class="navbar-wrapper">
          <a class="navbar-brand" href="/admin/manager-category"> <i class="fas fa-angle-left"></i>QUẢN LÝ LOẠI NHÀ (Litle Category)</a>
        </div>
    ...
    <div class="content">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <button style="margin-left: 20px"type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalThem">
