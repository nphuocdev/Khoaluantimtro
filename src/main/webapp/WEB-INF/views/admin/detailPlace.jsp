            ...
            <div class="container-fluid">
                <div class="row noidung">
                    <div class="col-md-12">
                        ...
                        <b style="color: #0c5460;font-weight: bold">Ảnh</b> <br>
                        <br>
                        ...
                        <hr>
                        <br>
                        <h5 style="color: #0c5460;font-weight: bold">Thông tin cơ bản về phòng cho thuê</h5>
                        <br>
                        <%-- <form action="<c:url value="/become-a-host/detailplace/editplace/${detailPlace.placeId }" />" method="post"> --%>
                        <label style="color: #0c5460;font-weight: bold">Tiêu đề </label><br>
                        ...
                        <label style="color: #0c5460;font-weight: bold"> Mô tả </label><br>
                        ...
                        <label style="color: #0c5460;font-weight: bold">Vị trí</label><br>
                        ...
                        <label style="color: #0c5460;font-weight: bold">Giá cho thuê </label>
                        ...
                        <p class="asa">Ngày cho thuê  phòng</p><br>
                        <label style="color: #0c5460;font-weight: bold">Ngày bắt đầu </label>
...
<%--                        <br>--%>
                        ...
                        <!--  -->
                        <label style="color: #0c5460;font-weight: bold" class="asa">Trạng thái phòng cho thuê </label><br><br>
                        <c:choose>
                            <c:when test="${place.isEmpty == 'true' }">
                                <input value="true" name="radio" type="radio" class="date isEmpty" value="1"
                                       checked> Đã đăng<br>
                                <p class="note">Khách có thể tìm thấy phòng cho thuê của bạn trong kết quả tìm kiếm
                                    và yêu cầu thông tin về tình trạng còn phòng trống.</p>
                                <input value="false" name="radio" type="radio" class="date isEmpty"
                                       value="0"> Đã hủy <br>
                                <p class="note">Khách không thể tìm thấy phòng cho thuê của bạn trong
                                    kết quả tìm kiếm.</p>
                            </c:when>
                            <c:otherwise>
                        ...
                        <br>
                        <label style="color: #0c5460;font-weight: bold">Số lượng người cho phép</label>
                        ...
                        <%----%>
                        <br>
                        <label style="color: #0c5460;font-weight: bold">Số lượng phòng cho thuê</label>
                        ...
                        <!--  -->
                        <br>
                        <p style="color: #0c5460;font-weight: bold">Chỗ ở và phòng</p>

                        <label style="color: #0c5460;font-weight: bold">Phòng ngủ: </label>
                ...
                <hr>
                <!-- </form> -->
                <h3><b style="color: #0c5460;font-weight: bold">Thông tin cơ bản về chủ nhà</b></h3><br>
