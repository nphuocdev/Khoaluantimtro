        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example"  style="background-color: darkslategrey !important;color:#fff">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="<c:url value="/manager-place" />">QUẢN LÝ PHÒNG TRỌ</a>
                </div>
												...
												<tr >
													...
													<td>
														<a href="<c:url value="/admin/manager-place/detail/${item.placeId }" />"><h5>
															<b style="color: #0c5460;font-weight:bold ">${item.name }</b></h5></a>
														<i>${item.address } </i><br>
                                                        <div class="row">
                                                            <div class="col-1">
                                                                <i class="material-icons" style="color: #ee731f;">star</i>
                                                            </div>
                                                            <div class="col-3">
                                                                    ${rate}
                                                            </div>
														...
														<c:choose>
															...
															<c:otherwise>
																<p><a id="status-on-${item.placeId }" class="st-on" style="color: #fff !important;background-color: darkcyan;"
																	  data-on="${item.placeId }">Chưa xác nhận</a></p>
															</c:otherwise>
														</c:choose>
													</td>
													<td class="chucnang">
