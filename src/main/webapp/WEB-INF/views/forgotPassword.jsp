            ...
            <div class="container">
                <div class="row">
                    <div class="col-5 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
                        <div class="bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('/asset/login/img/illustrations/register.jpg'); background-size: cover;position: -webkit-sticky;position: sticky; top: 0; height: 100%">
                        </div>
                    </div>
                        ...
                        <div class="card card-plain">
                            ...
                            <div class="card-body">
                                <form class="form" method="post" action="/search-account">
                                    ...
                                    <div  class="text-center">
                                        <button style="background-color: #0d6efd;color: #fff3cd" type="submit" class="btn btn-lg  btn-lg w-40 mt-4 mb-0">Tìm kiếm</button>
                                    </div>
                                </form>
                            </div>
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-2 text-sm mx-auto">
                                    Bạn đã có tài khoản?
                                    <a href="/login" style="color: #0c5460;font-size: 16px" class=" font-weight-bold">Đăng nhập</a>
                                </p>
                            </div>
                        </div>
                    </div>
